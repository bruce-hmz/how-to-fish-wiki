    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="bg-ocean-900/80 border border-ocean-800 rounded-xl p-6 space-y-3 text-sm text-gray-300">
        <p>
          ...
          covers the safety rules alongside the payoff. One patch-note update: since 1.0.12, stacked dynamite
          is dependable damage against the final boss too — the official notes fixed explosives failing to
          damage it &ldquo;even when landing on its tail&rdquo; (see the{' '}
