    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="bg-ocean-900/80 border border-ocean-800 rounded-xl divide-y divide-ocean-800/60 text-sm">
          ...
          <div className="p-4"><span className="font-bold text-blue-300">Beginner Lure</span><span className="text-gray-400"> — island 2 tier: Piranha, Pike, Cod, Goby, Salmon, Perch, <a href="/fish/triggerfish/" className="text-aqua hover:underline">Triggerfish</a>, Goldfish.</span></div>
